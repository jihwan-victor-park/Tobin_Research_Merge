> **ARCHIVED — superseded, do not follow.** Written 2026-06-14. Its figures
> (~916K companies) and its instruction to never push to `main` are both out
> of date: the database now holds 988,576 companies and `main` is the deploy
> branch. Kept for the record of what the state was in June.
