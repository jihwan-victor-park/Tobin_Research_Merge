...
# "Home V2" is the experimental homepage redesign; it lives at ?v=2 and takes
# over the whole shell (its own header and theme), leaving everything below
# untouched. Selecting any other page returns here.
